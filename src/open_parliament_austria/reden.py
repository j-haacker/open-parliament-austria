"""Module for requests to API endpoint 251
...
db_con = _get_db_connector("metadata_api_251.db")
index_col = ["Personen_ID", "Datum"]
index_sqltypes = ["INTEGER", "DATETIME"]
pd_read_sql = _get_pd_sql_reader(index_col)
download_global_metadata = _get_coll_downloader(
    db_con, "reden", index_col, index_sqltypes, False
)
